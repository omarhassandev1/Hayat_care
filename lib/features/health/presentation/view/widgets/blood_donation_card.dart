...
class BloodDonationCard extends StatefulWidget {
  const BloodDonationCard({super.key, this.isSeeAllButtonAvailable = false});
...
class _BloodDonationCardState extends State<BloodDonationCard> {
  ...
  Widget build(BuildContext context) {
    ...
    bool isArabic = locale.localeName == "ar";
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(
                          width: 270.w,
                          child: Text(
                            AppLocalizations.of(context)!.everyDropBlood,
                            style: TextStyle(
                              fontSize: 15.sp,
                              color: Colors.white,
                        ...
                        SizedBox(
                          width: 250.w,
                          child: Text(
                            AppLocalizations.of(context)!.saveWithBloodDonation,
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 14.sp,
                        ...
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            foregroundColor: AppColors.bloodyRedColor,
                          ),
                          child: Text(
