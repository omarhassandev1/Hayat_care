...
class _CancelAppointmentScreenState extends State<CancelAppointmentScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final local = AppLocalizations.of(context)!;
    final doctor = widget.appointmentWithDoctor.doctor;
                    ...
                    onPressed: _isValid
                      ...
                      showDialog(
                        ...
                        builder: (_) => SuccessDialog(
                          title: local.appointmentCancelledTitle,
                          subtitle:
                          '${local.appointmentCancelledSubtitle} ${doctor.name}.',
