  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.of(
          context,
        ).push(MaterialPageRoute(builder: (context) => DoctorProfileScreen()));
      },
      child: SizedBox(
        width: 213.w,
        child: Column(
...
class TopDoctorsHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          Text(AppLocalizations.of(context)!.topDoctors, style: Theme.of(context).textTheme.labelMedium!.copyWith(fontWeight: FontWeight.w700)),
          Spacer(),
          GestureDetector(
            onTap: () {},
            child: Text(
